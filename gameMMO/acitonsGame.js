...
const selectedElement = (elementName) => {
  ...
  if (!clicked) {
    // Устанавливаем стили для выбранного элемента при первом клике
...
// Добавляем обработчики события "click" к элементам
